...
(function(){
  ...
  GT.hendrixGuide = { CHANGES, DRILLS, RHYTHM, LEAD, MIXED, EXERCISES, STUDIES, SONGS, SOURCES, GRIPS: GRIP_GROUPS, jamLink: dive.jamLink, drillsLink: dive.drillsLink, openLink: dive.openLink, realiseExample: dive.realiseExample, chordNeck: dive.chordNeck, scaleNeck: dive.scaleNeck, gripSVG: dive.gripSVG };
})();
