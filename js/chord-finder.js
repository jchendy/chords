...
(function(){
  ...
  // the left-hand fingering model lives in js/fingering.js, shared with the
  // tab's fingering display and the ear-training diagrams
  const { computeFingering } = GT.fingering;
  ...
  const HENDRIX_SHAPES = [
    ...
    { pattern: 'x-0-2-2-2-0', name: 'the A-shape barre, with the fingers freed' },
    { pattern: 'x-0-2-2-2-x', name: 'the A-shape barre, the ring finger across D, G and B' },
