...
- "Chord chart / Tabbed guitar part" — on its own line under the key, the
  ...
  the tempo over it, the bars packed as printed tab spaces them and one
  row an SVG so no row splits across pages (`js/tab-print.js`). See **Suggested parts** below for how a part written
