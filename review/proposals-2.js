  ...
  genres.push({
    ...
    additions: [
      ...
      },
      {
        ...
        why: `<p>Open chords arpeggiated in continuous sixteenths with the open strings ringing through the changes — the chord broken over its octave with the 9th and the 6th as color, never a flat strum. The kit stays light, the bass on eighths. Realized in Scales so the color tones are there.</p>`,
    ...
    additions: [
      {
        ...
        why: `<p>Swing band in cowboy hats: a walking bass in quarters, a brushed kit, and the rhythm guitar playing four to the bar on 6th and 9th chords — jazz voicings, country tune — with steel-guitar-like double-stop bends in the fills. Needs shell voicings, color tones and double-stop bends.</p>`,
    ...
    additions: [
      {
        ...
        why: `<p>The clean, melodic side: a picked eighth-note bass line on the low strings (Duane Eddy's twang), a melody in single notes with vibrato and slides, the chords stabbed short behind. Slapback echo is the sound. Realized in the minor key.</p>`,
