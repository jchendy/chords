      ...
      // ---------------------------------------------------------------------
      {
        ...
        parts: [
          ...
          },
          {
            ...
            blues: true,
            why: 'A lead part over the groove: the pedal following the phrase — a sweep on the held note, the pick and the pedal together on the short ones — in the Dorian color the funk sits in, the 6th and the 9th free against the minor pentatonic, double-stop chucks between phrases, the trill, the octave. Phrases start on the "and" and end on the beat.',
